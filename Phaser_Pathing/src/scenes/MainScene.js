...
export default class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Start: bottom-left of dirt path. End: right edge row 15.
        // Adjust these if the path console warns tile not found.
        ...
        if (!startTile) console.warn(`Start tile (${START_TX},${START_TY}) not found in path layer`);
        if (!endTile)   console.warn(`End tile (${END_TX},${END_TY}) not found in path layer`);
        ...
        if (startTile && endTile) {
            ...
            if (foundEnd) {
                ...
                console.warn('BFS failed to connect start to end — check START/END tile coords');
            }
        }
